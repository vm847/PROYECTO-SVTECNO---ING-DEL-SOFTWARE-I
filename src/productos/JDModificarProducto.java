...
public class JDModificarProducto extends javax.swing.JDialog {
    ...
    private void mostrarRegistro(String codigo){
        ...
        if(!bd.seleccionarItemComboBD(cboClasificacion, Integer.parseInt(datos[5])))
            this.setClasificacion(Integer.parseInt(datos[5]), datos[6]);
        if(!bd.seleccionarItemComboBD(cboMarca, Integer.parseInt(datos[7])))
            this.setMarca(Integer.parseInt(datos[7]), datos[8]);
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnNuevaImg2, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 180, 40, 40));
        ...
        jPanel1.add(img2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 20, 150, 150));

        img1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel1.add(img1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 150, 150));
        ...
        jPanel1.add(btnNuevaImg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 180, 40, 40));
        ...
        jPanel1.add(btnEliminarImg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 180, 40, 40));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 100, 50, 30));
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        String cod_barras = this.txtCodBarras.getText();
        ...
        if(!nombre.isEmpty()){
            if(!precio.isEmpty()){
                if(!bd.verificarDuplicidadString("productos", "cod_barras", cod_barras, "cod_producto", codigo)){
                    String valores = "cod_barras='" + cod_barras 
                    ...
                    JOptionPane.showMessageDialog(null, "EL CODIGO DE BARRAS YA EXITE, NO SE PUEDE REPETIR");
                }
            }
