...
public class JDBuscador extends javax.swing.JDialog {
    ...
    private JDNuevaLineaCredito jDNuevaLineaCredito = null;
    private JDModificarLineaCredito jDModificarLineaCredito = null;
    ...
    public JDBuscador(java.awt.Dialog parent, boolean modal, 
            JDNuevaLineaCredito jDNuevaLineaCredito,
            JDModificarLineaCredito jDModificarLineaCredito,
            String [] campos, String condicion, String [] cabeceras, int [] ancho
    ) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        if(jDNuevaLineaCredito != null)this.jDNuevaLineaCredito = jDNuevaLineaCredito;
        if(jDModificarLineaCredito != null)this.jDModificarLineaCredito = jDModificarLineaCredito;
        miGrilla1.configurarModelo(grdBuscar, cabeceras, ancho);
        miGrilla1.cargarGrilla(grdBuscar, "clientes", campos, condicion); 
        this.condiciones();
    ...
    private void grdBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grdBuscarMouseClicked
        if(evt.getClickCount() == 2){
            ...
            if(fila != -1){
                ...
                if(jDNuevaLineaCredito != null)jDNuevaLineaCredito.setCliente(codigo,nombre);
                this.dispose();
            }
        }
