 ...
 * @author Asus
 */
public class JDEliminarLineaCredito extends javax.swing.JDialog {
    ...
    public JDEliminarLineaCredito(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public JDEliminarLineaCredito(java.awt.Frame parent, boolean modal, FrmLineaCredito frmLineaCredito, String usuLogeado, String codigo) {
        super(parent, modal);
        initComponents();
        ...
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setTitle("Eliminar Linea de Credito - " + usuLogeado);
        this.mostrarDatos(codigo);
    }
    
    private void mostrarDatos(String codigo){
        String sql = "select lc.cod_linea_credito, lc.cod_cliente, CONCAT(cl.nombre_cliente,' ',cl.apellido_cliente),"
                + " lc.monto_total, lc.fecha_vencimiento, lc.estado_linea_credito from lineas_credito lc "
        ...
        if(datos != null){
            ...
            bd.agregarItemCombo(cboEstado, 1, datos[5]);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(dateVencimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 120, 30));
        ...
        jPanel1.add(cboCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 290, 30));

        cboEstado.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jPanel1.add(cboEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 170, 120, 30));

        jLabel13.setFont(new java.awt.Font("Meiryo UI", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Estado");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 170, 40, 30));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        bd.borrarRegistro("lineas_credito", "cod_linea_credito=" + codigo);
        frmLineaCredito.limpiarCampos();
        this.dispose();
        JOptionPane.showMessageDialog(null, "Linea de Credito Eliminada", "Registro Eliminado", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDEliminarLineaCredito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDEliminarLineaCredito dialog = new JDEliminarLineaCredito(new javax.swing.JFrame(), true);
