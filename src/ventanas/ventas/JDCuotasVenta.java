 ...
 * @author Asus
 */
public class JDCuotasVenta extends javax.swing.JDialog {
    ...
    public JDCuotasVenta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.txtCuotas.setText("10");
        this.plazo = "SEMESTRAL";
    ...
    public JDCuotasVenta(java.awt.Frame parent, boolean modal, FrmVentas frmVentas, Float monto, String fechaC, String [][] cuotas) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
    ...
    public JDCuotasVenta(java.awt.Frame parent, boolean modal, FrmVentas frmVentas, String [][] cuotas) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
            ...
            for (int i = 0; i < 4; i++) {
                switch (i) {
                    case 0:
                        ...
                        miGrilla.alinearCentrar(grdCuotas, i);
                        break;
                    case 1:
                        tabla.setValueAt(cuotas[x][1],x,i);
                        miGrilla.alinearDerecha(grdCuotas, 1);
                        break;
                    case 2:
                        tabla.setValueAt(cuotas[x][2],x,i);
                        miGrilla.formatoFechaGrilla(grdCuotas, 2);
                        miGrilla.alinearCentrar(grdCuotas, i);
                        break;
                    case 3:
...
@SuppressWarnings("unchecked")
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(this.accion.equals("generado")){
            if(this.txtMontoCredito.getText().equals(this.txtSaldoRestante.getText())){
                ...
                this.leerCuotas();
                this.dispose();
                frmVentas.guardarVentaCredito(numCuotas, plazo, vencimiento, this.cuotas);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCuotasVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCuotasVenta dialog = new JDCuotasVenta(new javax.swing.JFrame(), true);
