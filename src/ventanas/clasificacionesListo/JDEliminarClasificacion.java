 ...
 * @author Asus
 */
public class JDEliminarClasificacion extends javax.swing.JDialog {
    BaseDatos1 bd = new BaseDatos1();
    String usuarioLogeado = "INDEFINIDO";
    private FrmClasificaciones frmClasificaciones;
    
    public JDEliminarClasificacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public JDEliminarClasificacion(java.awt.Frame parent, boolean modal, FrmClasificaciones frmClasificaciones, String usuLogeado, String codigo) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setTitle("Eliminar Clasificacion - " + usuLogeado);
    ...
    private void mostrarRegistro(String codigo){
        ...
        bd.agregarItemCombo(cboEstado, 1,datos[2]);
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        bd.borrarRegistro("clasificacion", "cod_clasificacion=" + codigo);
        frmClasificaciones.actualizarGrilla();
        this.dispose();
        JOptionPane.showMessageDialog(null, "Clasificacion Eliminada", "Registro Eliminado", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDEliminarClasificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDEliminarClasificacion dialog = new JDEliminarClasificacion(new javax.swing.JFrame(), true);
