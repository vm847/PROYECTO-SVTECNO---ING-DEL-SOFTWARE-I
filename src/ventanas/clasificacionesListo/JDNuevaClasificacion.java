 ...
 * @author Asus
 */
public class JDNuevaClasificacion extends javax.swing.JDialog {
    ...
    public JDNuevaClasificacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setTitle("Nueva Clasificacion");
        this.txtCodigo.setText(bd.obtenerCodMaximoRegistro("clasificacion", "cod_clasificacion"));
    }

    public JDNuevaClasificacion(java.awt.Frame parent, boolean modal, FrmClasificaciones frmClasificaciones, String usuLogeado) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setTitle("Nueva Clasificacion - " + usuLogeado);
        this.restricciones();
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if(!nombre.isEmpty()){
            if(!bd.verificarDuplicidadString("clasificacion", "nombre_clasificacion", nombre, "cod_clasificacion", codigo)){
                String campos = "nombre_clasificacion, usuario_insercion, fecha_insercion";

                String valores = "'" + nombre + "','" + usuarioLogeado +"',NOW()";
                bd.insertarRegistro("clasificacion", campos, valores);
                frmClasificaciones.actualizarGrilla();
                this.dispose();
                JOptionPane.showMessageDialog(null, "Nueva Clasificacion Guardada", "Registro Guardado", JOptionPane.INFORMATION_MESSAGE);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDNuevaClasificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDNuevaClasificacion dialog = new JDNuevaClasificacion(new javax.swing.JFrame(), true);
