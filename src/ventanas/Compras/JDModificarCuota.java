...
public class JDModificarCuota extends javax.swing.JDialog {
    ...
    private JDCuotasCompra jDCuotasCompra;
    ...
    public JDModificarCuota(java.awt.Dialog parent, boolean modal, JDCuotasCompra jDCuotasCompra, String fechaC, String numCuota, String monto, String fechaV, String estado, int fila) {
        super(parent, modal);
        initComponents();
        ...
        this.jDCuotasCompra = jDCuotasCompra;
        this.fechaC = fechaC;
        this.fila = fila;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(fe.compararFechas_dd_MM_yyyy(fechaC, fe.formatoFechaBDaJava(fe.formatoFecha(dateFechaVencimiento)))){
            jDCuotasCompra.setCuota(this.txtNumero.getText(), this.txtMonto.getText(), fe.formatoFechaBDaJava(fe.formatoFecha(dateFechaVencimiento)), this.fila);
            this.dispose();            
        }else{
