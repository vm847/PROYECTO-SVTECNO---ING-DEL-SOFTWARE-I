...
public class JDBuscador extends javax.swing.JDialog {
    ...
    public JDBuscador(java.awt.Frame parent, boolean modal, FrmCompras frmCompras, String tabla, String [] campos, String condicion, String [] cabeceras, int [] ancho) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
    ...
    private void txtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyPressed
        if(this.tablaA.equals("proveedores")){
            ...
            gr.cargarGrilla(grdBuscar, tabla, campos, " where nombre_proveedor LIKE '%" + this.txtBuscar.getText() + "%'" +
        ...
        if(this.tablaA.equals("productos p")){
            ...
            gr.cargarGrilla(grdBuscar, tabla, campos, "  join marcas m on p.cod_marca = m.cod_marca "
                + "where p.nombre_producto LIKE '%" + this.txtBuscar.getText() + "%'" +
                " OR m.nombre_marca LIKE '%"+ this.txtBuscar.getText() + "%'");
        }
        if(this.tablaA.equals("credito_proveedor cp")){
    ...
    private void grdBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grdBuscarMouseClicked
        if(evt.getClickCount() == 2){
            ...
            if(fila != -1){
                ...
                if(this.tablaA.equals("cuotas_credito_proveedor ccp ")){
                    String codigo = this.grdBuscar.getValueAt(fila, 0).toString();
                    String nombre = this.grdBuscar.getValueAt(fila, 1).toString();
