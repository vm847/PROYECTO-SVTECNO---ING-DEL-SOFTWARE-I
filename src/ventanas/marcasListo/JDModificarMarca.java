 ...
 * @author Admision-2
 */
public class JDModificarMarca extends javax.swing.JDialog {
    BaseDatos1 bd = new BaseDatos1();
    FrmAjustes aj = new FrmAjustes();
    String usuarioLogeado;
    private FrmMarcas frmMarcas;
    
    public JDModificarMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public JDModificarMarca(java.awt.Frame parent, boolean modal, FrmMarcas frmMarcas, String codigo, String usuLogeado) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setTitle("Modificar Marca - " + usuLogeado);
        this.restricciones();
    ...
    private void restricciones(){
        aj.soloMayusculas(txtNombreMarca, 50);
    }
    ...
    private void initComponents() {
        ...
        txtCodigoMarca.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String codigoMarca = this.txtCodigoMarca.getText();
        String estadoMarca = this.cboEstado.getSelectedItem().toString();
        if(!nombreMarca.isEmpty()){
            if(!bd.verificarDuplicidadString("marcas", "nombre_marca", nombreMarca, "cod_marca", codigoMarca)){
                bd.modificarRegistro("marcas",
                ...
                this.dispose();
                JOptionPane.showMessageDialog(null, "Marca Actualizada", "Registro Actualizado", JOptionPane.INFORMATION_MESSAGE);
            }else{
                JOptionPane.showMessageDialog(null, "Esta marca ya esta registrada");
            }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDModificarMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDModificarMarca dialog = new JDModificarMarca(new javax.swing.JFrame(), true);
