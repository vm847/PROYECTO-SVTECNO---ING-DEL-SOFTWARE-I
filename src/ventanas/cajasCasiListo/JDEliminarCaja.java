 ...
 * @author Admision-2
 */
public class JDEliminarCaja extends javax.swing.JDialog {
    BaseDatos1 bd = new BaseDatos1();
    Fechas fe = new Fechas();
    private FrmCajas frmCajas;
    String usuarioLogeado = "INDEFINIDO";
    
    public JDEliminarCaja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public JDEliminarCaja(java.awt.Frame parent, boolean modal, FrmCajas frmCajas, String codigo, String usuLogeado) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, 90, 40));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        bd.borrarRegistro("cajas", "cod_caja = " + codigo);
        frmCajas.actualizarGrilla();
        this.dispose();
        JOptionPane.showMessageDialog(null, "Caja Eliminada", "Registro Eliminado", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDEliminarCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDEliminarCaja dialog = new JDEliminarCaja(new javax.swing.JFrame(), true);
