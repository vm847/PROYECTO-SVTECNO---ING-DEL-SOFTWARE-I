 ...
 * @author Asus
 */
public class JDNuevaCaja extends javax.swing.JDialog {
    BaseDatos1 bd = new BaseDatos1();
    Fechas fe = new Fechas();
    String usuarioLogeado;
    private FrmCajas frmCajas;
    
    public JDNuevaCaja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.txtCodigo.setText(bd.obtenerCodMaximoRegistro("cajas", "cod_caja"));
        ...
        fe.mostrarFechaHoraJDateChooser(dateApertura, fe.obtenerFechaHoraActual());
        this.cboUsuario.requestFocus();
    }

    public JDNuevaCaja(java.awt.Frame parent, boolean modal, FrmCajas frmCajas, String usuLogeado) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        this.setTitle("Nueva Caja - " + usuLogeado);
    ...
    private void initComponents() {
        ...
        dateCierre.setDateFormatString("dd-MM-yyyy HH:mm");
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 50, 30));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(fechaApertura != "-1"){
            String campos = "cod_caja,cod_usuario,fecha_apertura_caja,usuario_insercion,fecha_insercion";
            String valores = codigo + "," + codUsuario + ",'" + fechaApertura + "','" + usuarioLogeado + "',NOW()";
            bd.insertarRegistro("cajas", campos, valores);
            frmCajas.actualizarGrilla();
            this.dispose();
            JOptionPane.showMessageDialog(null, "Nueva Caja Guardada", "Registro Guardado", JOptionPane.INFORMATION_MESSAGE);
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDNuevaCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDNuevaCaja dialog = new JDNuevaCaja(new javax.swing.JFrame(), true);
