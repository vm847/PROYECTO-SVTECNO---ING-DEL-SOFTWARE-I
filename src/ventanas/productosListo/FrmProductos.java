...
public class FrmProductos extends javax.swing.JFrame {
    ...
    public void actualizarGrilla(){
        ...
        String [] campos = {"pr.cod_producto", "pr.nombre_producto", "cl.nombre_clasificacion", "ma.nombre_marca", "pr.precio_producto", "pr.existencia_producto", "pr.iva_producto", 
            "pr.estado_producto", "pr.usuario_insercion", "pr.fecha_insercion", "pr.usuario_modificacion", "pr.fecha_modificacion"};
    ...
    private void initComponents() {
        ...
        if (grdProductos.getColumnModel().getColumnCount() > 0) {
            grdProductos.getColumnModel().getColumn(0).setPreferredWidth(50);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        String condicion = " JOIN marcas ma ON pr.cod_marca = ma.cod_marca "
                ...
                + "WHERE pr.nombre_producto LIKE '%"+ valor + "%' "
                + "OR cl.nombre_clasificacion LIKE '%" + valor + "%' "
                + "OR ma.nombre_marca LIKE '%" + valor + "%' "
                + "OR pr.precio_producto LIKE '%" + valor + "%' "
                + "OR pr.existencia_producto LIKE '%" + valor + "%' "
                + "OR pr.iva_producto LIKE '%" + valor + "%' "
                + "OR pr.estado_producto LIKE '" + valor + "%' ";
        miGrilla1.cargarGrilla(grdProductos, tabla, campos, condicion);
