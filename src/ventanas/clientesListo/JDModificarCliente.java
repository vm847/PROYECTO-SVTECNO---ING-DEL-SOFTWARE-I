...
public class JDModificarCliente extends javax.swing.JDialog {
    ...
    public JDModificarCliente(java.awt.Frame parent, boolean modal, FrmClientes frmClientes, String codigo, String usuLogeado) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.setResizable(false);
        setTitle("MODIFICAR CLIENTE - " + usuLogeado);
        this.restricciones();
        ...
        if(!nombre.isEmpty()){
            if(!ruc.isEmpty()){
                if( !bd.verificarDuplicidadString("clientes", "nombre_cliente", nombre, "cod_cliente", codigo) &&
                    ...
                    String campos = "nombre_cliente='" + nombre
                    + "', apellido_cliente='" + apellido
                    + "', ruc_cliente='" + ruc
                    + "', sexo_cliente='" + sexo
                    + "', fecha_nacimiento_cliente='" + fechaN
                    + "', direccion_cliente='" + direccion
                    + "', telefono_cliente= '" + telefono
                    + "', estado_cliente= '" + estado
                    + "', usuario_modificacion='" + this.usuarioLogeado
                    + "', fecha_modificacion= NOW()";
                    String criterio = "cod_cliente=" + codigo;
                    bd.modificarRegistro(tabla, campos, criterio);
                    frmClientes.actualizarGrilla();
                    this.dispose();
                    JOptionPane.showMessageDialog(null, "Cliente Actualizado", "Registro Actualizado", JOptionPane.INFORMATION_MESSAGE);
                }else{
