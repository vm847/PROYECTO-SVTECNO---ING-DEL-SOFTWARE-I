 ...
 * @author PC
 */
public class FrmBuscadorPresupuesto extends javax.swing.JFrame {
    ...
    public FrmBuscadorPresupuesto(FrmPresupuesto frmPresupuesto, String tabla, String [] campos, String condicion, String [] cabeceras, int [] ancho) {
        initComponents();
        this.precionarEsc();
        this.tablaA = tabla;
    ...
    private void txtBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyPressed
        miGrilla1.filtrarGrilla(grdBuscar, this.txtBuscar.getText());
        ...
        if(evt.getClickCount() == 2){
            ...
            if(fila != -1){
                if(this.tablaA.equals("clientes")){
                    ...
                    String nombre = this.grdBuscar.getValueAt(fila, 1).toString() + " " + this.grdBuscar.getValueAt(fila, 2).toString();
                    String ruc = this.grdBuscar.getValueAt(fila, 3).toString();
                    frmPresupuesto.setCliente(codigo, nombre, ruc);
                    this.dispose();                    
                }
                if(this.tablaA.equals("productos p")){
                    ...
                    frmPresupuesto.setProducto(codigo, nombre, precio, iva);
                    this.dispose();
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscadorPresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuscadorPresupuesto().setVisible(true);
            }
        });
    }
