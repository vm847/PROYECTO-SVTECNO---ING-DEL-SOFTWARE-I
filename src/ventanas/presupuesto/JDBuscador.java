...
public class JDBuscador extends javax.swing.JDialog {
    ...
    public JDBuscador(java.awt.Frame parent, boolean modal, FrmPresupuesto frmPresupuesto, String tabla, String [] campos, String condicion, String [] cabeceras, int [] ancho) {
        super(parent, modal);
        initComponents();
        ...
        if(evt.getClickCount() == 2){
            ...
            if(fila != -1){
                if(this.tablaA.equals("clientes")){
                    frmPresupuesto.setCliente(this.grdBuscar.getValueAt(fila, 0).toString(), this.grdBuscar.getValueAt(fila, 1).toString(),
