 ...
 * @author PC
 */
public class FrmBuscadorVentas extends javax.swing.JFrame {
    Grilla miGrilla1 = new Grilla();
    private FrmVentas frmVentas;
    String tablaA;
    
    public FrmBuscadorVentas() {
        initComponents();
    }

    public FrmBuscadorVentas(FrmVentas frmVentas, String tabla, String [] campos, String condicion, String [] cabeceras, int [] ancho) {
        initComponents();
        this.precionarEsc();
        this.tablaA = tabla;
        ...
        if(evt.getClickCount() == 2){
            ...
            if(fila != -1){
                if(this.tablaA.equals("clientes")){
                    ...
                    frmVentas.setCliente(codigo, nombre, ruc);
                    this.dispose();                    
                }
                if(this.tablaA.equals("productos p")){
                    String codigo = this.grdBuscar.getValueAt(fila, 0).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscadorVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuscadorVentas().setVisible(true);
            }
        });
    }
